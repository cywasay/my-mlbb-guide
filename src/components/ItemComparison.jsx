                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 p-3 bg-gray-900 rounded-lg border border-gray-600 hover:border-[#1fab89] transition-all duration-200 hover:bg-gray-850">
                      ...
                      {/* Item Icon */}
                      <div className="w-12 h-12 bg-gray-800 rounded-lg border border-gray-600 flex items-center justify-center flex-shrink-0 group-hover:border-[#1fab89]/50 transition-colors">
                        {item.image ? (
                          <img
                            src={item.image}
                            alt={item.name}
